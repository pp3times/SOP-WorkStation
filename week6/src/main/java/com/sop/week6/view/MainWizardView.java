package com.sop.week6.view;

import com.sop.week6.pojo.Wizard;
import com.sop.week6.pojo.Wizards;
    ...
    public MainWizardView() {
        ...
        this.deleteBtn.addClickListener(e -> {
            WebClient
                    ...
                    .body(Mono.just(this.wizards.getModel().get(this.wizardIndex)), Wizard.class)
                    .retrieve()
        ...
        this.nextBtn.addClickListener(e -> {
            this.wizardIndex = Math.min(this.wizardIndex+1, this.wizards.getModel().size()-1);
            this.updateField();
        });
...
//
    private void updateField() {
        ...
        this.nextBtn.setEnabled(!(this.wizardIndex == this.wizards.getModel().size()-1));
        this.fullNameField.setValue(this.wizards.getModel().get(this.wizardIndex).getName());
        this.genderRadioGroup.setValue(this.wizards.getModel().get(this.wizardIndex).getSex() == 'm' ? "Male" : "Female");
        this.positionSelectionBox.setValue(this.wizards.getModel().get(this.wizardIndex).getPosition().equals("student") ? "Student" : "Teacher");
        this.moneyField.setValue((double) this.wizards.getModel().get(this.wizardIndex).getMoney());
        this.schoolSelectionBox.setValue(this.wizards.getModel().get(this.wizardIndex).getSchool());
        this.houseSelectionBox.setValue(this.wizards.getModel().get(this.wizardIndex).getHouse());
    }
}
